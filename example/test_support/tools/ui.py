...
from meshagent.api import JsonResponse
...
class AskUser(Tool):
    def __init__(self, *, name: str = "ask_user", description: str = "ask user question", title: str = "Ask User"):
        super().__init__(name=name, description=description, title=title, input_schema=askUserSchema)
...
class Toast(Tool):
    def __init__(self, *, name: str = "show_toast",
                 description: str = "let the user know something important (will be shown as a toast)",
                 title: str = "show user a toast"):
        super().__init__(name=name, description=description, title=title, input_schema=toastSchema)
